    ...
    return (
      <div className="App">
        <div className="container" style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gridGap: 20 }}>
          ...
          <TradeCenter price={price} cash={this.state.cash} stocks={this.state.stocks} processTrade={this.processTrade}/>
        </div>
      </div>
    );
  }
...
class TradeCenter extends React.Component{  
  render() {
    ...
    return (
      <div style={{display:"grid", gridTemplateRows: "1fr 2fr 5fr 2fr"}}>
        <div/>
        <StatusDisp price={price} cash={cash} stocks={stocks}/>
        <CtrlPanel price={price} cash={cash} stocks={stocks} processTrade={processTrade}/>    
    </div>
    )
